...
def main():
    ...
    openai.api_key = "sk-proj-HNWHTvSHQdDE7pm07RDET3BlbkFJKmHoyUvNFRIGUVL2MA4D"
    # Print a welcome message
    print("\nMeet the Mr.Roboto chatbot, here to help you with your Python needs! Type 'quit' to exit.\n")
